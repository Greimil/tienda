       ...
       <main className=" md:pt-20 md:paddings mb-4">
         <div className="flex justify-around  flex-col md:flex-row bg">
               ...
               {carrito.map((current) => {
                 return (
                   <div
                     ...
                     key={nanoid()}
                     className="flex justify-between  min-w-[560px] max-w-[760px] m-4 md:m-0  border-b-2 border-gray-500 p-1"
                   >
                     <div className="w-40 h-40 aspect-video bg-white p-2">
                       <img
                         src={current.titulo}
                         alt=""
                     ...
                     <div className="h-full flex-1 flex flex-col  gap-2 p-2 md:p-4 text-black">
                       <h4 className="font-bold text-2xl ">{current.img}</h4>
           ...
           <section className="md:w-[40%] p-4  ">
             <h1 className="text-2xl font-semibold mt-6 mb-6 ">Resumen de tu carrito</h1>
             <input
               type="text"
             ...
             <div className="">
               {carrito.map((current) => {
                 return (
                   ...
                   >
                     <strong className="font-normal" >{current.img}:</strong>
